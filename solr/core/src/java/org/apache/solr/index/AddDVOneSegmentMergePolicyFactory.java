...
public class AddDVOneSegmentMergePolicyFactory extends MergePolicyFactory {
  ...
  public AddDVOneSegmentMergePolicyFactory(SolrResourceLoader resourceLoader, MergePolicyFactoryArgs args, IndexSchema schema) {
  ...
  public MergePolicy getMergePolicy() {
    return new AddDVOneSegmentMergePolicy(schema);
  }
}
 ...
 */
class AddDVOneSegmentMergePolicy extends TieredMergePolicy implements RewriteSegments {
  ...
  AddDVOneSegmentMergePolicy(IndexSchema schema) {
    this.schema = schema;
  }
...
class AddDocValuesOneMerge extends MergePolicy.OneMerge {
  ...
  public void setMergeInfo(SegmentCommitInfo info) {
    info.info.getDiagnostics().put(AddDVOneSegmentMergePolicyFactory.REWRITE_INFO_PROP, rewriteInfo);
